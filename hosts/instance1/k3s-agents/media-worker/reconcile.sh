...
readonly SERVER_CONFIG="${REPO_ROOT}/hosts/instance1/k3s/config.yaml"
readonly SERVER_MODULES="${REPO_ROOT}/hosts/instance1/k3s/modules-load.conf"
readonly SERVER_SYSCTL="${REPO_ROOT}/hosts/instance1/k3s/sysctl.conf"
